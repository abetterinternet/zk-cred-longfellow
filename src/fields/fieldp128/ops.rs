//! Autogenerated: word_by_word_montgomery --lang Rust --inline -o 'fieldp128/ops.rs' p128 64 '2^128 - 2^108 + 1' to_montgomery from_montgomery to_bytes from_bytes add sub opp mul square msat divstep_precomp divstep selectznz one
//! curve description: p128
//! machine_wordsize = 64 (from "64")
//! requested operations: to_montgomery, from_montgomery, to_bytes, from_bytes, add, sub, opp, mul, square, msat, divstep_precomp, divstep, selectznz, one
...
/// The function fiat_p128_msat returns the saturated representation of the prime modulus.
///
/// Postconditions:
...
#[inline]
pub const fn fiat_p128_msat(mut out1: &mut [u64; 3]) {
  *IndexConst(&mut out1).index_mut(0) = (0x1 as u64);
  *IndexConst(&mut out1).index_mut(1) = 0xfffff00000000000;
  *IndexConst(&mut out1).index_mut(2) = (0x0 as u64);
}

/// The function fiat_p128_divstep_precomp returns the precomputed value for Bernstein-Yang-inversion (in montgomery form).
///
/// Postconditions:
...
///   out1: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
#[inline]
pub const fn fiat_p128_divstep_precomp(mut out1: &mut [u64; 2]) {
  *IndexConst(&mut out1).index_mut(0) = 0x1000;
  *IndexConst(&mut out1).index_mut(1) = 0x1ffffd000010000;
}

/// The function fiat_p128_divstep computes a divstep.
///
/// Preconditions:
///   0 ≤ eval arg4 < m
///   0 ≤ eval arg5 < m
...
#[inline]
pub const fn fiat_p128_divstep(out1: &mut u64, mut out2: &mut [u64; 3], mut out3: &mut [u64; 3], mut out4: &mut [u64; 2], mut out5: &mut [u64; 2], arg1: u64, arg2: &[u64; 3], arg3: &[u64; 3], arg4: &[u64; 2], arg5: &[u64; 2]) {
  let mut x1: u64 = 0;
  let mut x2: fiat_p128_u1 = 0;
  fiat_p128_addcarryx_u64(&mut x1, &mut x2, 0x0, (!arg1), (0x1 as u64));
  let x3: fiat_p128_u1 = (((x1 >> 63) as fiat_p128_u1) & (((*IndexConst(arg3).index(0)) & (0x1 as u64)) as fiat_p128_u1));
  let mut x4: u64 = 0;
  let mut x5: fiat_p128_u1 = 0;
  fiat_p128_addcarryx_u64(&mut x4, &mut x5, 0x0, (!arg1), (0x1 as u64));
  let mut x6: u64 = 0;
  fiat_p128_cmovznz_u64(&mut x6, x3, arg1, x4);
  let mut x7: u64 = 0;
  fiat_p128_cmovznz_u64(&mut x7, x3, (*IndexConst(arg2).index(0)), (*IndexConst(arg3).index(0)));
  let mut x8: u64 = 0;
  fiat_p128_cmovznz_u64(&mut x8, x3, (*IndexConst(arg2).index(1)), (*IndexConst(arg3).index(1)));
  let mut x9: u64 = 0;
  fiat_p128_cmovznz_u64(&mut x9, x3, (*IndexConst(arg2).index(2)), (*IndexConst(arg3).index(2)));
  let mut x10: u64 = 0;
  let mut x11: fiat_p128_u1 = 0;
  fiat_p128_addcarryx_u64(&mut x10, &mut x11, 0x0, (0x1 as u64), (!(*IndexConst(arg2).index(0))));
  let mut x12: u64 = 0;
  let mut x13: fiat_p128_u1 = 0;
  fiat_p128_addcarryx_u64(&mut x12, &mut x13, x11, (0x0 as u64), (!(*IndexConst(arg2).index(1))));
  let mut x14: u64 = 0;
  let mut x15: fiat_p128_u1 = 0;
  fiat_p128_addcarryx_u64(&mut x14, &mut x15, x13, (0x0 as u64), (!(*IndexConst(arg2).index(2))));
  let mut x16: u64 = 0;
  fiat_p128_cmovznz_u64(&mut x16, x3, (*IndexConst(arg3).index(0)), x10);
  let mut x17: u64 = 0;
  fiat_p128_cmovznz_u64(&mut x17, x3, (*IndexConst(arg3).index(1)), x12);
  let mut x18: u64 = 0;
  fiat_p128_cmovznz_u64(&mut x18, x3, (*IndexConst(arg3).index(2)), x14);
  let mut x19: u64 = 0;
  fiat_p128_cmovznz_u64(&mut x19, x3, (*IndexConst(arg4).index(0)), (*IndexConst(arg5).index(0)));
  let mut x20: u64 = 0;
  fiat_p128_cmovznz_u64(&mut x20, x3, (*IndexConst(arg4).index(1)), (*IndexConst(arg5).index(1)));
  let mut x21: u64 = 0;
  let mut x22: fiat_p128_u1 = 0;
  fiat_p128_addcarryx_u64(&mut x21, &mut x22, 0x0, x19, x19);
  let mut x23: u64 = 0;
  let mut x24: fiat_p128_u1 = 0;
  fiat_p128_addcarryx_u64(&mut x23, &mut x24, x22, x20, x20);
  let mut x25: u64 = 0;
  let mut x26: fiat_p128_u1 = 0;
  fiat_p128_subborrowx_u64(&mut x25, &mut x26, 0x0, x21, (0x1 as u64));
  let mut x27: u64 = 0;
  let mut x28: fiat_p128_u1 = 0;
  fiat_p128_subborrowx_u64(&mut x27, &mut x28, x26, x23, 0xfffff00000000000);
  let mut x29: u64 = 0;
  let mut x30: fiat_p128_u1 = 0;
  fiat_p128_subborrowx_u64(&mut x29, &mut x30, x28, (x24 as u64), (0x0 as u64));
  let x31: u64 = (*IndexConst(arg4).index(1));
  let x32: u64 = (*IndexConst(arg4).index(0));
  let mut x33: u64 = 0;
  let mut x34: fiat_p128_u1 = 0;
  fiat_p128_subborrowx_u64(&mut x33, &mut x34, 0x0, (0x0 as u64), x32);
  let mut x35: u64 = 0;
  let mut x36: fiat_p128_u1 = 0;
  fiat_p128_subborrowx_u64(&mut x35, &mut x36, x34, (0x0 as u64), x31);
  let mut x37: u64 = 0;
  fiat_p128_cmovznz_u64(&mut x37, x36, (0x0 as u64), 0xffffffffffffffff);
  let mut x38: u64 = 0;
  let mut x39: fiat_p128_u1 = 0;
  fiat_p128_addcarryx_u64(&mut x38, &mut x39, 0x0, x33, (((x37 & (0x1 as u64)) as fiat_p128_u1) as u64));
  let mut x40: u64 = 0;
  let mut x41: fiat_p128_u1 = 0;
  fiat_p128_addcarryx_u64(&mut x40, &mut x41, x39, x35, (x37 & 0xfffff00000000000));
  let mut x42: u64 = 0;
  fiat_p128_cmovznz_u64(&mut x42, x3, (*IndexConst(arg5).index(0)), x38);
  let mut x43: u64 = 0;
  fiat_p128_cmovznz_u64(&mut x43, x3, (*IndexConst(arg5).index(1)), x40);
  let x44: fiat_p128_u1 = ((x16 & (0x1 as u64)) as fiat_p128_u1);
  let mut x45: u64 = 0;
  fiat_p128_cmovznz_u64(&mut x45, x44, (0x0 as u64), x7);
  let mut x46: u64 = 0;
  fiat_p128_cmovznz_u64(&mut x46, x44, (0x0 as u64), x8);
  let mut x47: u64 = 0;
  fiat_p128_cmovznz_u64(&mut x47, x44, (0x0 as u64), x9);
  let mut x48: u64 = 0;
  let mut x49: fiat_p128_u1 = 0;
  fiat_p128_addcarryx_u64(&mut x48, &mut x49, 0x0, x16, x45);
  let mut x50: u64 = 0;
  let mut x51: fiat_p128_u1 = 0;
  fiat_p128_addcarryx_u64(&mut x50, &mut x51, x49, x17, x46);
  let mut x52: u64 = 0;
  let mut x53: fiat_p128_u1 = 0;
  fiat_p128_addcarryx_u64(&mut x52, &mut x53, x51, x18, x47);
  let mut x54: u64 = 0;
  fiat_p128_cmovznz_u64(&mut x54, x44, (0x0 as u64), x19);
  let mut x55: u64 = 0;
  fiat_p128_cmovznz_u64(&mut x55, x44, (0x0 as u64), x20);
  let mut x56: u64 = 0;
  let mut x57: fiat_p128_u1 = 0;
  fiat_p128_addcarryx_u64(&mut x56, &mut x57, 0x0, x42, x54);
  let mut x58: u64 = 0;
  let mut x59: fiat_p128_u1 = 0;
  fiat_p128_addcarryx_u64(&mut x58, &mut x59, x57, x43, x55);
  let mut x60: u64 = 0;
  let mut x61: fiat_p128_u1 = 0;
  fiat_p128_subborrowx_u64(&mut x60, &mut x61, 0x0, x56, (0x1 as u64));
  let mut x62: u64 = 0;
  let mut x63: fiat_p128_u1 = 0;
  fiat_p128_subborrowx_u64(&mut x62, &mut x63, x61, x58, 0xfffff00000000000);
  let mut x64: u64 = 0;
  let mut x65: fiat_p128_u1 = 0;
  fiat_p128_subborrowx_u64(&mut x64, &mut x65, x63, (x59 as u64), (0x0 as u64));
  let mut x66: u64 = 0;
  let mut x67: fiat_p128_u1 = 0;
  fiat_p128_addcarryx_u64(&mut x66, &mut x67, 0x0, x6, (0x1 as u64));
  ...
  let mut x71: u64 = 0;
  fiat_p128_cmovznz_u64(&mut x71, x30, x25, x21);
  let mut x72: u64 = 0;
  fiat_p128_cmovznz_u64(&mut x72, x30, x27, x23);
  let mut x73: u64 = 0;
  fiat_p128_cmovznz_u64(&mut x73, x65, x60, x56);
  let mut x74: u64 = 0;
  fiat_p128_cmovznz_u64(&mut x74, x65, x62, x58);
  *out1 = x66;
