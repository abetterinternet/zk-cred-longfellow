...
/// The extend method, as defined in [2.2.1][1]. We interpolate a polynomial of degree `|nodes|`
/// from the provided evaluations at points `[0..nodes.len())` and then evaluate that polynomial at
/// `[0, evaluations)`.
///
