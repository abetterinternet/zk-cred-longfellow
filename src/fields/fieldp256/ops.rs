//! Autogenerated: word_by_word_montgomery --lang Rust --inline -o 'fieldp256/ops.rs' p256 64 '2^256 - 2^224 + 2^192 + 2^96 - 1' to_montgomery from_montgomery to_bytes from_bytes add sub opp mul square msat divstep_precomp divstep selectznz one
...
#[inline]
pub const fn fiat_p256_divstep(out1: &mut u64, mut out2: &mut [u64; 5], mut out3: &mut [u64; 5], mut out4: &mut [u64; 4], mut out5: &mut [u64; 4], arg1: u64, arg2: &[u64; 5], arg3: &[u64; 5], arg4: &[u64; 4], arg5: &[u64; 4]) {
  let mut x1: u64 = 0;
  let mut x2: fiat_p256_u1 = 0;
  fiat_p256_addcarryx_u64(&mut x1, &mut x2, 0x0, (!arg1), (0x1 as u64));
  let x3: fiat_p256_u1 = (((x1 >> 63) as fiat_p256_u1) & (((*IndexConst(arg3).index(0)) & (0x1 as u64)) as fiat_p256_u1));
  let mut x4: u64 = 0;
  ...
  let mut x7: u64 = 0;
  fiat_p256_cmovznz_u64(&mut x7, x3, (*IndexConst(arg2).index(0)), (*IndexConst(arg3).index(0)));
  let mut x8: u64 = 0;
  fiat_p256_cmovznz_u64(&mut x8, x3, (*IndexConst(arg2).index(1)), (*IndexConst(arg3).index(1)));
  let mut x9: u64 = 0;
  fiat_p256_cmovznz_u64(&mut x9, x3, (*IndexConst(arg2).index(2)), (*IndexConst(arg3).index(2)));
  let mut x10: u64 = 0;
  fiat_p256_cmovznz_u64(&mut x10, x3, (*IndexConst(arg2).index(3)), (*IndexConst(arg3).index(3)));
  let mut x11: u64 = 0;
  fiat_p256_cmovznz_u64(&mut x11, x3, (*IndexConst(arg2).index(4)), (*IndexConst(arg3).index(4)));
  let mut x12: u64 = 0;
  let mut x13: fiat_p256_u1 = 0;
  fiat_p256_addcarryx_u64(&mut x12, &mut x13, 0x0, (0x1 as u64), (!(*IndexConst(arg2).index(0))));
  let mut x14: u64 = 0;
  let mut x15: fiat_p256_u1 = 0;
  fiat_p256_addcarryx_u64(&mut x14, &mut x15, x13, (0x0 as u64), (!(*IndexConst(arg2).index(1))));
  let mut x16: u64 = 0;
  let mut x17: fiat_p256_u1 = 0;
  fiat_p256_addcarryx_u64(&mut x16, &mut x17, x15, (0x0 as u64), (!(*IndexConst(arg2).index(2))));
  let mut x18: u64 = 0;
  let mut x19: fiat_p256_u1 = 0;
  fiat_p256_addcarryx_u64(&mut x18, &mut x19, x17, (0x0 as u64), (!(*IndexConst(arg2).index(3))));
  let mut x20: u64 = 0;
  let mut x21: fiat_p256_u1 = 0;
  fiat_p256_addcarryx_u64(&mut x20, &mut x21, x19, (0x0 as u64), (!(*IndexConst(arg2).index(4))));
  let mut x22: u64 = 0;
  ...
  let mut x27: u64 = 0;
  fiat_p256_cmovznz_u64(&mut x27, x3, (*IndexConst(arg4).index(0)), (*IndexConst(arg5).index(0)));
  let mut x28: u64 = 0;
  fiat_p256_cmovznz_u64(&mut x28, x3, (*IndexConst(arg4).index(1)), (*IndexConst(arg5).index(1)));
  let mut x29: u64 = 0;
  fiat_p256_cmovznz_u64(&mut x29, x3, (*IndexConst(arg4).index(2)), (*IndexConst(arg5).index(2)));
  let mut x30: u64 = 0;
  fiat_p256_cmovznz_u64(&mut x30, x3, (*IndexConst(arg4).index(3)), (*IndexConst(arg5).index(3)));
  let mut x31: u64 = 0;
  let mut x32: fiat_p256_u1 = 0;
